...
Plans:
- [x] 05-01-PLAN.md -- Admin layout, track list page, drag-and-drop upload with status polling, status API endpoint
- [x] 05-02-PLAN.md -- Track metadata edit page (title, slug, description, category, tags, cover art) and Caddy forward_auth protection
