...
decisions:
  ...
  - id: bind-mount-volumes
    decision: "Use bind mount (/home/user/wallybrain-music/data:/data) instead of named Docker volume"
...
- docker-compose.yml with bind mount for persistent data at /home/user/wallybrain-music/data
