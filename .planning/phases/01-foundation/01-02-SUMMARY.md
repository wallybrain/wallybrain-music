...
### Created/Modified
- `/home/lwb3/wallybrain-music/docker-compose.yml` — added webproxy network
- `/home/lwb3/v1be-code-server/docker-compose.yml` — added webproxy network to all 3 services
- `/home/lwb3/v1be-code-server/Caddyfile` — added @music named matcher routing
