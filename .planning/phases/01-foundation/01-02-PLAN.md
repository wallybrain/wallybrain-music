...
must_haves:
  ...
  artifacts:
    - path: "docker-compose.yml"
      ...
      contains: "webproxy"
    - path: "/home/lwb3/v1be-code-server/docker-compose.yml"
      provides: "V1be stack joined to external network"
      contains: "webproxy"
    - path: "/home/lwb3/v1be-code-server/Caddyfile"
...
@/home/lwb3/v1be-code-server/docker-compose.yml
@/home/lwb3/v1be-code-server/Caddyfile
</context>
...
<task type="auto">
  ...
  <files>
    /home/lwb3/wallybrain-music/docker-compose.yml
    /home/lwb3/v1be-code-server/docker-compose.yml
    /home/lwb3/v1be-code-server/Caddyfile
  </files>
  <action>
    ...
    **Step 4: Update Caddyfile**
    Edit /home/lwb3/v1be-code-server/Caddyfile to add music routes. The /music routes must be INSIDE the {$DOMAIN} block and BEFORE the catch-all reverse_proxy code-server:8080.
    ...
    **Step 5: Restart all containers**
    ...
    1. Stop the wallybrain-music container: `docker compose -f /home/lwb3/wallybrain-music/docker-compose.yml down`
    2. Stop the V1be stack: `docker compose -f /home/lwb3/v1be-code-server/docker-compose.yml down`
    3. Start the V1be stack (now on webproxy network): `docker compose -f /home/lwb3/v1be-code-server/docker-compose.yml up -d`
    4. Wait for V1be stack to be healthy (Caddy, Authelia, code-server)
    5. Start the wallybrain-music container: `docker compose -f /home/lwb3/wallybrain-music/docker-compose.yml up -d`
  ...
  <verify>
    ...
    3. `docker compose -f /home/lwb3/v1be-code-server/docker-compose.yml ps` shows all 3 services healthy
    4. `docker compose -f /home/lwb3/wallybrain-music/docker-compose.yml ps` shows wallybrain-music healthy
  </verify>
  <done>
...
3. SQLite database at /home/lwb3/wallybrain-music/data/db/music.db has tracks, tags, track_tags tables
