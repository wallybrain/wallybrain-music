...
must_haves:
  ...
  key_links:
    ...
    - from: "src/routes/admin/tracks/[id]/+page.svelte"
      ...
      pattern: "use:enhance"
    - from: "/home/lwb3/v1be-code-server/Caddyfile"
      to: "authelia:9091"
...
<task type="auto">
  ...
  <verify>
    Run `npx svelte-check --tsconfig ./tsconfig.json` for zero TypeScript errors. Rebuild Docker container with `docker compose -f /home/lwb3/wallybrain-music/docker-compose.yml up -d --build`. If there are tracks in the database, verify:
...
<task type="auto">
  ...
  <action>
    **Modify the Caddyfile** at `/home/lwb3/v1be-code-server/Caddyfile`:
