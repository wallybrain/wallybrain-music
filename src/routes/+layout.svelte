...
<div class="min-h-screen flex flex-col">
  <nav class="sticky top-0 z-[300] border-b border-border-subtle/50 backdrop-blur-md bg-surface-base/80">
    <div class="w-full px-2 sm:px-4 h-11 sm:h-8 flex items-center justify-between">
      <div class="flex items-center gap-0.5 sm:gap-1">
        <a
          href="https://wallyblanchard.com/fnord.html"
          class="px-1.5 sm:px-2 py-2 sm:py-0.5 rounded text-[11px] sm:text-[10px] font-mono tracking-wider sm:tracking-widest transition-colors whitespace-nowrap
      ...
      <div class="flex items-center gap-0.5 sm:gap-1">
        {#if data.isAuthenticated}
          <a
            ...
            data-sveltekit-reload
            class="px-1.5 sm:px-2 py-2 sm:py-0.5 rounded text-[11px] sm:text-[10px] font-mono tracking-wider sm:tracking-widest text-text-muted hover:text-text-secondary hover:bg-surface-overlay/50 transition-colors whitespace-nowrap"
          >
            Sign Out
          </a>
        {:else}
